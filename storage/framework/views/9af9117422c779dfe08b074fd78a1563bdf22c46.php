  ...
  fjs.parentNode.insertBefore(js, fjs);
            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <?php else: ?>
                        <li class="active"><?php echo e($producto->serie); ?> <?php echo e($producto->modelo()); ?></li>
                        <?php endif; ?>
                    </ol>
                </div>
            </div>
        ...
        <div class="container product no_pad_top">
            ...
            <div class="col-sm-6">
                <div class="row">
                    <?php if($producto->mx==0): ?>
                        <h1><?php echo e($producto->codigo); ?> <?php echo e($producto->tipo()); ?> <?php echo e($producto->marca()); ?> <?php echo e($producto->modelo()); ?></h1>
                    <?php else: ?>
                        <h1><?php echo e($producto->serie); ?> <?php echo e($producto->modelo()); ?></h1>
                    <?php endif; ?>
                ...
                <div class="row product-count">
                    ...
                    <div class="inline-block"><a class="btn btn_checkout" href="pago-seguro.php"><i class="fa fa-check"></i> Comprar</a></div>
                ...
                <div class="container tab-content">
                    <div class="tab-pane fade in active" id="description">
                        <div class="row">
                            <div class="col-sm-4">
                            <?php if($producto->mx==0): ?>
                                <h2><?php echo e($producto->codigo); ?> <?php echo e($producto->tipo()); ?> <?php echo e($producto->marca()); ?> <?php echo e($producto->modelo()); ?></h2>
                            <?php else: ?>
                                <h2><?php echo e($producto->serie); ?> <?php echo e($producto->modelo()); ?></h2>
                            <?php endif; ?>
                                    ...
                                    <table class="table table-bordered table-condensed">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="bg_blanco"><?php echo e($producto->serie); ?> <?php echo e($producto->modelo()); ?></td>
                                            </tr>
                                            <tr>
