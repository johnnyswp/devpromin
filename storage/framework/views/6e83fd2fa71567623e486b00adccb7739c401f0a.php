...
<div class="">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <a href="<?php echo e(url('admin/modelos/create')); ?>" class="btn btn-round btn-success btn-md"><i class="fa fa-plus"></i> Agregar</a>
    ...
    <div class="well" style="overflow: auto">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
            ...
            <?php echo e(Form::select('filtro', ['all'=>'Todos','linea'=>'Linea de negocio','marca'=>'Marca','modelo'=>'Modelo','tipo'=>'Tipo de producto'], $input->filtro, ['class'=>'form-control', 'onchange'=>'this.form.submit()'])); ?>
        ...
        <table class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo e(Carbon\Carbon::parse($modelo->created_at)->format('d').'-'.trans('main.'.Carbon\Carbon::parse($modelo->created_at)->format('m')).'-'.Carbon\Carbon::parse($modelo->created_at)->format('Y')); ?></td>

              <td><?php echo e($modelo->nombre); ?></td>

              <td><?php echo e($modelo->marca); ?></td>

              <td><?php echo e($modelo->tipo); ?></td>

              <td><?php echo e($modelo->linea); ?></td>

              <td>

              <a href="<?php echo e(url('admin/modelos/'.$modelo->id.'/edit')); ?>" class="btn btn-warning btn-xs" alt="Editar"><i class="fa fa-pencil"></i></a>

              <a data-toggle="modal" data-target="#myModal<?php echo e($modelo->id); ?>" class="btn btn-danger btn-xs" alt="Eliminar"><i class="fa fa-remove"></i></a>
                            <div class="modal fade" id="myModal<?php echo e($modelo->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    <form id="del-form<?php echo e($modelo->id); ?>" action="<?php echo e(route('modelos.destroy',$modelo->id)); ?>" method="POST" style="display: block;">
