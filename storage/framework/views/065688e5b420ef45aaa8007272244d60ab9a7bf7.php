        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <select name="cliente" id="cliente" class="form-control">
              ...
              <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clientee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($clientee->id); ?>"><?php echo e($clientee->nombre); ?></option>
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <select name="linea" id="lineas" class="form-control">
              ...
              <?php $__currentLoopData = $lineas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lineaa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($lineaa->id); ?>"><?php echo e($lineaa->nombre); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
          ...
          <div class="col-md-3">
            ...
            <?php echo e(Form::select('order_linea', ['asc'=>'A-Z','desc'=>'Z-A','new'=>'Más reciente','old'=>'Más antigua'], NULL, ['class'=>'form-control'])); ?>

          </div>

          <div class="col-md-3">
            <label for="">Ordenar tipo de producto:</label>
            <?php echo e(Form::select('order_tipo', ['asc'=>'A-Z','desc'=>'Z-A','new'=>'Más reciente','old'=>'Más antigua'], NULL, ['class'=>'form-control'])); ?>

          </div>

          <div class="col-md-3">
            <label for="">Ordenar marca:</label>
            <?php echo e(Form::select('order_marca', ['asc'=>'A-Z','desc'=>'Z-A','new'=>'Más reciente','old'=>'Más antigua'], NULL, ['class'=>'form-control'])); ?>

          </div>

          <div class="col-md-3">
            <label for="">Ordenar modelo:</label>
            <?php echo e(Form::select('order_modelo', ['asc'=>'A-Z','desc'=>'Z-A','new'=>'Más reciente','old'=>'Más antigua'], NULL, ['class'=>'form-control'])); ?>
...
<script src="<?php echo e(url('asset_admin/vendors/moment/min/moment.min.js')); ?>"></script>
<script src="<?php echo e(url('asset_admin/vendors/bootstrap-daterangepicker/daterangepicker.js')); ?>"></script>
<script type="text/javascript">
$(document).on('ready',function(){       
    $('#generar').click(function(){
        $.ajax({                        
           type: "POST",                 
           url: "<?php echo e(url('admin/reporte-wishlist')); ?>",
           data: $("#form").serialize(), 
           dataType: 'html',
...
$("#lineas").change(function() {
  ...
  $.ajax({
    method: "GET",
    url: "<?php echo e(url('admin/productos-filter/tipo')); ?>/"+$id,
    dataType: "html"
  })
  .done(function(msg) {
    $('#tipo .visible').remove();
    ...
    $("#tipo").change(function(){
      ...
      $.ajax({
        method: "GET",
        url: "<?php echo e(url('admin/productos-filter/marcas')); ?>/"+$id,
        dataType: "html"
      })
      ...
      .done(function(msg) {
        ...
        $("#marcas").change(function() {
          ...
          $.ajax({
            method: "GET",
            url: "<?php echo e(url('admin/productos-filter/modelos')); ?>/"+$id,
            dataType: "html"
          })
          .done(function( msg ) {
