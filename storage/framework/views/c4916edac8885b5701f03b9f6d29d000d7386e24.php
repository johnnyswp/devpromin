...
<div class="">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <a href="<?php echo e(url('admin/linea-negocios/create')); ?>" class="btn btn-round btn-success btn-md"><i class="fa fa-plus"></i> Agregar</a>
    ...
    <div class="well" style="overflow: auto">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
            ...
            <?php echo e(Form::select('cat', ['all'=>'Todas','mx'=>'MX','unidades'=>'Unidades'], $input->cat, ['class'=>'form-control', 'onchange'=>'this.form.submit()'])); ?>
        ...
        <table class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo e(Carbon\Carbon::parse($linea->created_at)->format('d').'-'.trans('main.'.Carbon\Carbon::parse($linea->created_at)->format('m')).'-'.Carbon\Carbon::parse($linea->created_at)->format('Y')); ?></td>

              <td><?php if($linea->tipo=="mx"): ?> MX <?php else: ?> Unidades <?php endif; ?></td>

              <td><img src="<?php echo e(asset($linea->picture)); ?>" width="80" alt=""></td>

              <td><?php echo e($linea->nombre); ?></td>

              <td><?php echo e($linea->siglas); ?></td>

              <td>

              <a href="<?php echo e(url('admin/linea-negocios/'.$linea->id.'/edit')); ?>" class="btn btn-warning btn-xs" alt="Editar"><i class="fa fa-pencil"></i></a>

              <a data-toggle="modal" data-target="#myModal<?php echo e($linea->id); ?>" class="btn btn-danger btn-xs" alt="Eliminar"><i class="fa fa-remove"></i></a>
                            <div class="modal fade" id="myModal<?php echo e($linea->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    <form id="del-form<?php echo e($linea->id); ?>" action="<?php echo e(route('linea-negocios.destroy',$linea->id)); ?>" method="POST" style="display: block;">
