...
<?php echo e(Form::model($producto, ['route' => ['productos.update', $producto->id],'files' => true, 'method' => 'put'])); ?>
...
<div class="row">
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
        <select name="linea_negocio_id" class="form-control" id="linea">
          <option value=""  <?php if(old('linea_negocio_id') == ""): ?> selected="selected" <?php endif; ?>>Seleccione una opción</option>
          ...
          <option value="<?php echo e($linea->id); ?>" <?php if(old('linea_negocio_id') == $linea->id): ?> selected="selected" <?php endif; ?>><?php echo e($linea->nombre); ?></option>
  ...
  <div class="col-md-6">
    <div class="form-group">
      ...
      <?php if(old('linea_negocio_id')!=""): ?>
        <select name="tipo_producto_id" class="form-control" id="tipos">
          <option value=""  <?php if(old('tipo_producto_id') == ""): ?> selected="selected" <?php endif; ?>>Seleccione una opción</option>

          <?php $__currentLoopData = $tipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($tipo->id); ?>" <?php if(old('tipo_producto_id') == $tipo->id): ?> selected="selected" <?php endif; ?>><?php echo e($tipo->nombre); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
      <?php else: ?>
        <select name="tipo_producto_id" class="form-control" id="tipos">
  ...
  <div class="col-md-6">
    ...
    <div class="form-group">
      ...
      <div class="col-md-8" id="marcas-data">
        <?php if(old('tipo_producto_id')!=""): ?>
          <select name="marcas_id" class="form-control" id="marcas">
            <option value=""  <?php if(old('marcas_id') == ""): ?> selected="selected" <?php endif; ?>>Seleccione una opción</option>
            <?php $__currentLoopData = $marcas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $marca): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($marca->id); ?>" <?php if(old('marcas_id') == $marca->id): ?> selected="selected" <?php endif; ?>><?php echo e($marca->nombre); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
        <?php else: ?>
          <select name="marcas_id" class="form-control" id="marcas">
  ...
  <div class="col-md-6">
    ...
    <div class="form-group">
      ...
      <div class="col-md-8" id="modelos-data">
        <?php if(old('marcas_id')!=""): ?>
          <select name="modelo_id" class="form-control" id="modelos">
            <option value=""  <?php if(old('modelo_id') == ""): ?> selected="selected" <?php endif; ?>>Seleccione una opción</option>
            ...
            <option value="<?php echo e($modelo->id); ?>" <?php if(old('modelo_id') == $modelo->id): ?> selected="selected" <?php endif; ?>><?php echo e($modelo->nombre); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
        <?php else: ?>
          <select name="modelo_id" class="form-control" id="modelos">
...
<div class="row">
  ...
  <div class="col-md-3">
    ...
    <p id="mx">MX-<?php echo e($producto->id); ?></p>
  ...
  <div class="col-md-6">
    ...
    <p id="sku">MX-<?php echo e($producto->id); ?></p>
...
<div class="row">
  <div class="col-md-6">
    ...
    <?php echo e(Form::text('link_video', NULL, ['class'=>'form-control','placeholder'=>'https://www.youtube.com/embed/VIDEO_ID', 'id'=>'link_video'])); ?>
...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <?php $__currentLoopData = $imgs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <img rel="<?php echo e($img->id); ?>" src="<?php echo e($img->picture); ?>" class="img-thumbnail delete" id="<?php echo e($img->id); ?>" width="150">
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<div class="row">
  ...
  <div class="col-md-6">
    ...
    <ul class="lista_radio_inline">
      ...
      <li><label class="radio-inline"><?php echo e(Form::radio('state', 'public', true)); ?> Si</label></li>
  ...
  <div class="col-md-6">
    ...
    <ul class="lista_radio_inline">
      ...
      <li><label class="radio-inline"><?php echo e(Form::radio('destacado', '0', true)); ?> No</label></li>
    </ul>
